                ...
                <form action="https://getform.io/f/aroyznrb" className="xl:pl-10 2xl:pl-20" method='POST'>
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            <input type="email" name="email" id="email" autoComplete='email' required placeholder='johndoe@example.com' className="text-field"/>
                        </div>
                    </div>
                    <div className="mb-4">
                        ...
                        <textarea name="message" id="message" className="text-field resize-y min-h-32 max-h-80" required placeholder='Hi!'></textarea>
                    </div>
